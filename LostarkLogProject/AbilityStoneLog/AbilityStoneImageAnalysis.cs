...
{
    internal class AbilityStoneImageAnalysis
    {
        ...
        public AbilityStoneImageAnalysis(MainForm mainForm, ResourceLoader resourceLoader, FirestoreDb firestoreDb)
        {
        ...
        private void CaptureDisplay()
        {
            while (threadState)
            {
                ...
                {
                    mainForm.SetImageAnalysisStateText("Error : 세공창 인식 불가");
